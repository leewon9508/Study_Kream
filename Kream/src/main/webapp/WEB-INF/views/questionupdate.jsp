...
<body>
	 <div id="header">
        <div class="name">1:1 문의 글 수정 (회원 전용) + questionupdate</div>
        <div id=top>
	...
	<div id="content">
			<form action="questionupdateprocess" method="post" name="questionform">
				작성자 <input type="text" name="qwriter" value="${sessionScope.loginMember}" readonly="readonly"> <br> 
				제목 <input type="text" name="qtitle" maxlength="50" id="qtitle" value="${question.qtitle}"> <br> <br>
				내용 <textarea rows="30" cols="100" name="qcontents" id="qcontents" maxlength="1000" ></textarea><br> 
