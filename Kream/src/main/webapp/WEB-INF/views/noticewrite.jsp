...
<body>
	 <div id="header">
        <div class="name">공지사항 작성 + noticewrite</div>
        <div id=top>
	...
	<div id="content">
		<form action="noticewrite" method="post" name="noticeform">
			...
			제목 <input type="text" name="ntitle" maxlength="50" id="ntitle"> <br> <br>
			내용 <textarea rows="30" cols="100" name="ncontents" id="ncontents" maxlength="1000"></textarea> <br> 
