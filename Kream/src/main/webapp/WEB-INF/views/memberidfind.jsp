...
<body>
	<div id="header">
		<div class="name">아이디 찾기 + memberidfind</div>
		<div id=top>
	...
	<div id="content">
		<form action="idfindprocess" method="post">
		<table>
			<tr>
				<th>전화 번호 입력</th>
			</tr>
			<tr>
				<th><input type="text" name="mphone" id="mphone"
				onkeyup="phoneCheck()" placeholder="가입하신 휴대폰 번호"></th>
			</tr>
		</table>
		<br>
