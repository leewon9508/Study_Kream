...
<body>
	<div id="header">
       <div class="name">포인트 충전 내역 + pointchargelist</div>
        <div id=top>
	...
	<!-- 페이징 -->
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="pointchargelist?page=${paging.page-1}&mid=${sessionScope.loginMember}">[이전]</a>&nbsp;
			</c:otherwise>
		</c:choose>
		...
		<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i"
			...
			<c:choose>
				...
				<c:otherwise>
					<a href="pointchargelist?page=${i}&mid=${sessionScope.loginMember}">${i}</a>
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="pointchargelist?page=${paging.page+1}&mid=${sessionScope.loginMember}">[다음]</a>
			</c:otherwise>
		</c:choose>
	</div>
