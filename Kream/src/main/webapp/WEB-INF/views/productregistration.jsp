...
<body>
	<div id="header">
        <div class="name">제품 등록 + productregistration</div>
        <div id=top>
	...
	<div id="content">
		...
		<form action="productregistration" method="post"
			...
			<table>
				...
				<tr>
					<td>제품번호</td>
					<td><input type="text" name="pnumber" placeholder="숫자 만 입력"></td>
				</tr>
				<tr>
					<td>제품명</td>
				...
				<tr>
					<td>제품발매가</td>
					<td><input type="text" name="pretail" placeholder="숫자 만 입력"></td>
				</tr>
				<tr>
					<td>이미지</td>
