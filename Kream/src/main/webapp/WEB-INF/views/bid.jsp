...
<!-- 로그아웃 -->
	...
	function check(){
		...
		var bidpnumber = '${product.pnumber}';
		console.log(bidid);
		console.log(bidpnumber);
			$.ajax({
				type: 'post', 
				url: 'bididcheck',
				data: {'bidid': bidid,
						'bidpnumber': bidpnumber}, 
				dataType: 'text',
			...
			<c:if test="${sessionScope.loginMember != 'admin'}">
				<h5>구매 입찰 금액, 사이즈 입력</h5>
					<form action="bidinput" method="post" name="bidintputform">
						...
						입찰 금액<input type="text" name="bidprice" id="bidprice" placeholder="숫자로 금액을 입력하세요" />원 <br>
