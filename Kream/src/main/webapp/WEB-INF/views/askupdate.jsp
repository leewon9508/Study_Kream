...
<body>
<div id="header">
        <div class="name">매 입찰 수정 + askupdate</div>
        <div id=top>
	...
	<div id="content">
			<form action="askupdateprocess" method="post">
				...
				<table>
					...
					<tr>
						<td>입찰 금액</td>
						<td><input type="text" name="askprice" id="askprice" placeholder="기존금액 ${ask.askprice}원" /> 원</td>				
					</tr>
				</table>
				<br>
				<table>
					...
					<tr>
						<td>240</td>
						<td><input type="radio" id="asksize" name="asksize" value="240"></td>				
					</tr>
					<tr>
						<td>250</td>
						<td><input type="radio" id="asksize" name="asksize" value="250"></td>				
					</tr>
					<tr>
						<td>260</td>
						<td><input type="radio" id="asksize" name="asksize" value="260"></td>				
					</tr>
					<tr>
						<td>270</td>
						<td><input type="radio" id="asksize" name="asksize" value="270"></td>				
					</tr>
				</table>
				<br>
