...
<body>
<div id="header">
        <div class="name">구매 입찰 수정 + bidupdate</div>
        <div id=top>
	...
	<div id="content">
			<form action="bidupdateprocess" method="post">
				...
				<table>
					...
					<tr>
						<td>입찰 금액</td>
						<td><input type="text" name="bidprice" id="bidprice" placeholder="기존금액 ${bid.bidprice}원" /> 원 </td>				
					</tr>
				</table>
				<br>
				<table>
					...
					<tr>
						<td>240</td>
						<td><input type="radio" id="bidsize" name="bidsize" value="240"></td>				
					</tr>
					<tr>
						<td>250</td>
						<td><input type="radio" id="bidsize" name="bidsize" value="250"></td>				
					</tr>
					<tr>
						<td>260</td>
						<td><input type="radio" id="bidsize" name="bidsize" value="260"></td>				
					</tr>
					<tr>
						<td>270</td>
						<td><input type="radio" id="bidsize" name="bidsize" value="270"></td>				
					</tr>
				</table>
				<br>
